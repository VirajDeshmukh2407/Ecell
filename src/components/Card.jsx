        ...
        <div className="card">
          <div className="logo">
            ...
            <span className="circle circle5">
              ...
              <h1 className="text-gray-100">VD</h1>
            </span>
          </div>
          <div className="glass" />
          <div className="content">
            <span className="title">ECELL/IIC</span>
            <span className="text">More Than A Event Club</span>
          </div>
...
const StyledWrapper = styled.div`
  ...
  .card {
    ...
    justify-content: 0;
    align-items: center;
    background: linear-gradient(135deg, rgb(0, 0, 0) 0%, rgb(33, 33, 33) 100%);
