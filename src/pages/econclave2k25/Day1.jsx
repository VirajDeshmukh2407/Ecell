...
const Day1 = () => {
  return (
    <div className="border border-yellow-900/30 shadow-md m-20 overflow-hidden" style={{ boxShadow: "0px 0px 15px rgba(255, 215, 0, 0.6)" }}>
