...
//     <div
//       className="relative w-full h-screen bg-cover bg-center overflow-hidden mt-40"
//       style={{
//         backgroundImage: "url('./images/Econclave25/hp_bg.jpg')",
//       }}
//     >
...
//         {/* Econclave Image */}
//         <img
//           src="./images/Econclave25/Etitle.png"
//           alt="Econclave 2025"
...
const Hero = () => {
  ...
  return (
    ...
    <div
      className="relative w-full h-full bg-cover bg-center overflow-hidden mt-40"
    >
      <Vortex>
      {/* Overlay */}
